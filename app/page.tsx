        ...
        <section className="container mx-auto px-4 py-20 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
              A digital realm where your ideas take form and your work comes to life. Navigate through your projects
              with precision, organize tasks in a space designed for clarity, and watch your productivity materialize in
              real-time.
            </p>
            ...
            <div className="flex items-center space-x-6 text-sm text-gray-400">
              <span className="flex items-center space-x-1">
                ...
                <a
                  ...
                  href="https://github.com/copycut/grid"
                  target="_blank"
                >
                  Free Project
                </a>
              ...
              <span className="flex items-center space-x-1">
                ...
                <a className="text-primary-400! hover:text-white!" href="https://nextjs.org/" target="_blank">
                  Next.js
                </a>
                <span>&</span>
                <a className="text-primary-400! hover:text-white!" href="https://clerk.com/" target="_blank">
                  Clerk
                </a>
              </span>
            </div>
